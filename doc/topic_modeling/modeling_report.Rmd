...
The goal of this document is to preprocess the #zerowaste tweets, examine properties of the resulting dataset, find viable topic model, and present imprinted perspectives. The study is structured as follows:
...
```{r char_tok_histograms, fig.width=7, fig.height=4, fig.align="center"}
